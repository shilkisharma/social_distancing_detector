"""
Created on Tue Nov 18 16:59:08 2021
...
vs =cv2.VideoCapture( r"input1.jpg"if "input1.jpg"else 0)#r"pedestrian.mp4"if "pedestrian.mp4"else
writer =None
...
while True:
   ...
   # loop over the upper triangular of the distance matrix
    ...
    if r"social-distance-detector" != "" and writer is None:
        ...
        writer = cv2.VideoWriter(r"output.jpg",fourcc,25,(frame.shape[1],frame.shape[0]),True)
